...
| Ubuntu Slim<br>[![Latest Ubuntu Slim image release version](https://img.shields.io/github/v/release/wydler/runner-images-hetzner-cloud?filter=ubuntu-slim*)](https://img.shields.io/github/v/release/wydler/runner-images-hetzner-cloud?filter=ubuntu-slim*) | x64 | [ubuntu-slim] | [![Build status of Ubuntu Slim test workflow](https://github.com/wydler/runner-images-hetzner-cloud/actions/workflows/docker-images.yml/badge.svg?branch=customize)](https://github.com/wydler/runner-images-hetzner-cloud/actions/workflows/docker-images.yml) |
